...
(function () {
  ...
  function refreshButtonLayout() {
    ...
    // 3) 重新插入：排序后的按钮插回面板末尾（面板内无其他需保持在后的元素）
  ...
  function buildUI() {
    ...
    root.innerHTML = `
      ...
      <div class="stcj-btn stcj-mini stcj-collapse" data-action="toggleCollapse" title="收起面板"></div>
